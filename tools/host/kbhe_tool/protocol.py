...
FILTER_DEFAULT_NOISE_BAND = 8
FILTER_DEFAULT_ALPHA_MIN_DENOM = 1
FILTER_DEFAULT_ALPHA_MAX_DENOM = 8
...
ACTION_CAPABILITY_RUNTIME_STATE_COMMAND = 0x01
ACTION_CAPABILITY_EXTENDED_STATE_REPORT = 0x02
ACTION_STATE_REPORT_VERSION = 1
