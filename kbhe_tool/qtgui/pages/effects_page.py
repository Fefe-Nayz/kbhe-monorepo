...
EFFECT_METADATA = {
    ...
    13: ("Reactive (Key Press)", "Responds to key presses using the selected reactive color."),
...
EFFECT_PARAM_METADATA = {
    ...
    13: [{"label": "Reactive Color", "kind": "color"},
         {"index": 0, "label": "Decay", "kind": "slider", "default": 36},
         {"index": 1, "label": "Spread", "kind": "slider", "default": 96},
         {"index": 2, "label": "Base Glow", "kind": "slider", "default": 0, "max": 64},
         {"index": 3, "label": "White Core", "kind": "toggle", "default": 1},
         {"index": 4, "label": "Gain", "kind": "slider", "default": 192}],
