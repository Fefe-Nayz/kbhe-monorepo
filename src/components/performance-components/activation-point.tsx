  ...
  return (
    <Card className="w-full sm:w-80 md:w-96 lg:w-96 xl:w-[500px] 2xl:w-[600px] rounded-3xl border border-border bg-background shadow-sm">
      <CardHeader className="pb-4">
        <div>
          <CardTitle className="text-base">Activation Point</CardTitle>
          <CardDescription className="text-sm">Between 0.2 mm and 3 mm.</CardDescription>
        </div>
      </CardHeader>
          ...
          >
            <SliderPrimitive.Control className="relative h-full w-16 touch-none select-none flex justify-center">
              <SliderPrimitive.Track
                ...
                className="bg-muted rounded-sm border border-slate-300 h-full w-11 relative overflow-hidden select-none"
              >
