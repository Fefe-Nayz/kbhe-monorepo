...
const PRESETS: Record<string, CurvePoint[]> = {
  Linear: [{ x: 0, y: 200 }, { x: 117, y: 133 }, { x: 233, y: 67 }, { x: 350, y: 0 }],
  Aggressive: [{ x: 0, y: 200 }, { x: 50, y: 100 }, { x: 100, y: 25 }, { x: 350, y: 0 }],
  Slow: [{ x: 0, y: 200 }, { x: 200, y: 175 }, { x: 300, y: 125 }, { x: 350, y: 0 }],
  Smooth: [{ x: 0, y: 200 }, { x: 100, y: 180 }, { x: 250, y: 20 }, { x: 350, y: 0 }],
  Step: [{ x: 0, y: 200 }, { x: 100, y: 200 }, { x: 100, y: 0 }, { x: 350, y: 0 }],
  Instant: [{ x: 0, y: 200 }, { x: 0, y: 0 }, { x: 175, y: 0 }, { x: 350, y: 0 }],
  Digital: [{ x: 0, y: 200 }, { x: 175, y: 200 }, { x: 175, y: 0 }, { x: 350, y: 0 }],
};
