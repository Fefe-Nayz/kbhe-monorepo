...
const AllKeys = [
  ...
  { id: "1", label: "&", value: "Digit1", width: 1 },
  { id: "2", label: "é", value: "Digit2", width: 1 },
  { id: "3", label: "\"", value: "Digit3", width: 1 },
  { id: "4", label: "'", value: "Digit4", width: 1 },
  { id: "5", label: "(", value: "Digit5", width: 1 },
  { id: "6", label: "-", value: "Digit6", width: 1 },
  { id: "7", label: "è", value: "Digit7", width: 1 },
  { id: "8", label: "_", value: "Digit8", width: 1 },
  { id: "9", label: "ç", value: "Digit9", width: 1 },
  { id: "0", label: "à", value: "Digit0", width: 1 },
  { id: "minus", label: ")", value: "Minus", width: 1 },
  { id: "equal", label: "=", value: "Equal", width: 1 },
  { id: "tab", label: "Tab", value: "Tab", width: 1 },
  ...
  { id: "capslock", label: "Caps", value: "CapsLock", width: 1 },
  ...
  { id: "ù", label: "Ù", value: "Quote", width: 1 },
  { id: "shift", label: "Shift", value: "ShiftLeft", width: 1 },
  ...
  { id: "colon", label: ":", value: "Period", width: 1 },
  { id: "excl", label: "!", value: "Slash", width: 1 },
  { id: "ctrl", label: "Ctrl", value: "ControlLeft", width: 1 },
  { id: "win", label: <IconBrandWindows />, value: "win", width: 1 },
  { id: "alt", label: "Alt", value: "AltLeft", width: 1 },
  { id: "space", label: " ", value: "Space", width: 1 },
  { id: "altgr", label: "AltGr", value: "AltRight", width: 1 },
  { id: "fn", label: "Fn", value: "Fn", width: 1 },
  { id: "enter", label: "Enter", value: "Enter", width: 1 },
  { id: "backspace", label: "Backspace", value: "Backspace", width: 1 },
  { id: "shift_r", label: "Shift", value: "ShiftRight", width: 1 },
  { id: "pgup", label: "PgUp", value: "PageUp", width: 1 },
  { id: "pgdn", label: "PgDn", value: "PageDown", width: 1 },
  { id: "home", label: "Home", value: "Home", width: 1 },
  { id: "up", label: "↑", value: "ArrowUp", width: 1 },
  { id: "left", label: "←", value: "ArrowLeft", width: 1 },
  { id: "down", label: "↓", value: "ArrowDown", width: 1 },
  { id: "right", label: "→", value: "ArrowRight", width: 1 },
]

export default function KeyMapper() {
  return (
    <div className="flex flex-wrap gap-1 p-4 bg-white border border-gray-200 w-fit">
      {AllKeys.map((keyData) => (
        <Key
          key={keyData.id}
          id={keyData.id}
